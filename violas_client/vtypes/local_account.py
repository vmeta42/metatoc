...
from diem import diem_types, jsonrpc, utils, stdlib, identifier, chain_ids
from diem.serde_types import uint64
...
class LocalAccount:
    ...
    address: diem_types.AccountAddress = field(default=None)
    ...
    def account_address(self) -> diem_types.AccountAddress:
        ...
        return diem_types.AccountAddress.from_hex(self.address)
